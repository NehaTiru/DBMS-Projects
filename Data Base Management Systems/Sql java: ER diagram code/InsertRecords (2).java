...
public class InsertRecords {
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(dbServer, userName, password);
            ...
            String insertStudents = "INSERT INTO students (snum, ssn, name, gender, dob, c_addr, c_phone, p_addr, p_phone) VALUES "
            ...
            String insertDepartments = "INSERT INTO departments (code, name, phone, college) VALUES "
            ...
            // Insert degree records
            String insertDegrees = "INSERT INTO degrees (name, level, department_code) VALUES "
            ...
            // Insert major records
            String insertMajor = "INSERT INTO major (snum, name, level) VALUES "
            ...
            // Insert minor records
            String insertMinor = "INSERT INTO minor (snum, name, level) VALUES "
                    + "(1007, 'Applied Mathematics', 'MS'),"
                    + "(1005, 'Applied Mathematics', 'MS'),"
                    + "(1001, 'Software Engineering', 'BS');";

            // Insert course records
            String insertCourses = "INSERT INTO courses (number, name, description, credithours, level, department_code) VALUES "
            ...
            String insertRegister = "INSERT INTO register (snum, course_number, regtime, grade) VALUES "
                    + "(1001, 363, 'Fall2020', 3),"
                    + "(1002, 311, 'Fall2020', 4),"
                    + "(1003, 228, 'Fall2020', 4),"
            ...
            statement.addBatch(insertStudents);
            statement.addBatch(insertDepartments);
            statement.addBatch(insertDegrees);
            statement.addBatch(insertMajor);
            statement.addBatch(insertMinor);
            statement.addBatch(insertCourses);
            statement.addBatch(insertRegister);
